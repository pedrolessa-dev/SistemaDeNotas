...
public class NotasAvançado {

	public static void main(String[] args) {
	String[] nome={"Ricardo","Luís","Pedro","João","Lucas","Wesley","Flávia","Rebeca","Kátia","Bianca"};
	int resultado=0;
	...
	int analise=0;
		...
		case 1:
			...
			System.out.println(nome[aluno]+" - "+nota1[aluno]+" - "+nota2[aluno]+" - "+nota3[aluno]+" - "+nota4[aluno]+" - "+media+" - "+conceito);
			analise++;
			break;
		case 2:
			System.out.println("Nome - Nota 1 - Nota 2 - Nota 3 - Nota 4 - Média - Conceito");
			for(int contador=0;contador<nome.length;contador++) {
				...
				if (media<5) {
					...
					conceito="Recuperação";
				System.out.println(nome[contador]+" - "+nota1[contador]+" - "+nota2[contador]+" - "+nota3[contador]+" - "+nota4[contador]+" - "+media+" - "+conceito);
				}
			analise++;
			break;
		case 3:
